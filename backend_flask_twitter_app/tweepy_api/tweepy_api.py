...
# 4 cadenas son las claves de autenticacion para la API de Twitter
...
#Se añaden las claves por los respectivos métodos
auth = tweepy.OAuthHandler(consumer_key, consumer_secret)
auth.set_access_token(access_token, access_token_secret)

# Con el objeto "api" realizaremos todas las llamadas al API de Twitter
api = tweepy.API(auth,
